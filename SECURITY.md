...
If you find a security vulnerability in django-stateless-mcp, please report it through [GitHub's private vulnerability reporting](https://github.com/Streamlined-Analytics/django-stateless-mcp/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact ben@streamlinedanalytics.co.uk for details.
